# formfiller.py, automatically files out forms
...
formData  = [{'name':'Alice','fear':'eavesdroppers','source':'wand',
        ...
        'comments':'n/a'},
        {'name': 'Carol','fear':'puppets','source':'crystall ball',
...
print('Entering %s info...' %(preson['name']))
pyautogui.write(['\t','\t'])
...
# Fill out the source of the Wizard Power
